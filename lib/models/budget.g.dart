...
void _budgetSerialize(
  ...
  writer.writeDouble(offsets[4], object.percentageUsed);
  writer.writeString(offsets[5], object.period);
  writer.writeDouble(offsets[6], object.remainingAmount);
...
extension BudgetQueryFilter on QueryBuilder<Budget, Budget, QFilterCondition> {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> percentageUsedEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> percentageUsedGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> percentageUsedLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Budget, Budget, QAfterFilterCondition> percentageUsedBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension BudgetQuerySortBy on QueryBuilder<Budget, Budget, QSortBy> {
  ...
  QueryBuilder<Budget, Budget, QAfterSortBy> sortByPercentageUsed() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'percentageUsed', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> sortByPercentageUsedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BudgetQuerySortThenBy on QueryBuilder<Budget, Budget, QSortThenBy> {
  ...
  QueryBuilder<Budget, Budget, QAfterSortBy> thenByPercentageUsed() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'percentageUsed', Sort.asc);
    });
  }

  QueryBuilder<Budget, Budget, QAfterSortBy> thenByPercentageUsedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'percentageUsed', Sort.desc);
    });
  }
...
extension BudgetQueryWhereDistinct on QueryBuilder<Budget, Budget, QDistinct> {
  ...
  QueryBuilder<Budget, Budget, QDistinct> distinctByPercentageUsed() {
    return QueryBuilder.apply(this, (query) {
...
extension BudgetQueryProperty on QueryBuilder<Budget, Budget, QQueryProperty> {
  ...
  QueryBuilder<Budget, double, QQueryOperations> percentageUsedProperty() {
    return QueryBuilder.apply(this, (query) {
